...
const TEAM_DEFS: TeamDef[] = [
  ...
  { id:'ic_jax', name:'Jacksonville Jaguars',abbr:'JAX', conf:'IC', div:'South', tier:1 },
  { id:'ic_ind', name:'Indianapolis Speed',  abbr:'IND', conf:'IC', div:'South', tier:2 },
  // Iron Conference — East
  { id:'ic_ne',  name:'Boston Patriots',     abbr:'NE',  conf:'IC', div:'East',  tier:3 },
  ...
  { id:'ic_bal', name:'Baltimore Ravens',     abbr:'BAL', conf:'IC', div:'East',  tier:3 },
  // Iron Conference — West
  { id:'ic_den', name:'Denver Broncos',       abbr:'DEN', conf:'IC', div:'West',  tier:2 },
  { id:'ic_kc',  name:'Kansas City Chiefs',   abbr:'KC',  conf:'IC', div:'West',  tier:3 },
  { id:'ic_lv',  name:'Las Vegas Raiders',    abbr:'LV',  conf:'IC', div:'West',  tier:1 },
  { id:'ic_lac', name:'Los Angeles Bolts',    abbr:'LAC', conf:'IC', div:'West',  tier:2 },
  // Shield Conference — North
  { id:'sc_gb',  name:'Green Bay Packers',    abbr:'GB',  conf:'SC', div:'North', tier:3 },
  { id:'sc_chi', name:'Chicago Bears',        abbr:'CHI', conf:'SC', div:'North', tier:2 },
  { id:'sc_min', name:'Minnesota Vikings',    abbr:'MIN', conf:'SC', div:'North', tier:2 },
  { id:'sc_det', name:'Detroit Lions',        abbr:'DET', conf:'SC', div:'North', tier:1 },
  // Shield Conference — South
  { id:'sc_no',  name:'New Orleans Saints',   abbr:'NO',  conf:'SC', div:'South', tier:2 },
  { id:'sc_atl', name:'Atlanta Falcons',      abbr:'ATL', conf:'SC', div:'South', tier:1 },
  { id:'sc_car', name:'Carolina Panthers',    abbr:'CAR', conf:'SC', div:'South', tier:1 },
  { id:'sc_tb',  name:'Tampa Bay Buccaneers', abbr:'TB',  conf:'SC', div:'South', tier:2 },
  // Shield Conference — East
  { id:'sc_dal', name:'Dallas Cowboys',       abbr:'DAL', conf:'SC', div:'East',  tier:3 },
  { id:'sc_phi', name:'Philadelphia Eagles',  abbr:'PHI', conf:'SC', div:'East',  tier:2 },
  { id:'sc_was', name:'Washington Commanders',abbr:'WAS', conf:'SC', div:'East',  tier:1 },
  { id:'sc_nyg', name:'New York Giants',       abbr:'NYG', conf:'SC', div:'East',  tier:1 },
  // Shield Conference — West
  { id:'sc_lar', name:'Los Angeles Rams',     abbr:'LAR', conf:'SC', div:'West',  tier:2 },
  { id:'sc_sf',  name:'San Francisco Miners', abbr:'SF',  conf:'SC', div:'West',  tier:3 },
  { id:'sc_sea', name:'Seattle Seahawks',     abbr:'SEA', conf:'SC', div:'West',  tier:2 },
  { id:'sc_ari', name:'Arizona Cardinals',    abbr:'ARI', conf:'SC', div:'West',  tier:1 },
];
